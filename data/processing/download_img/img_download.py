...
chenyp     range(0,431471)
yuyingli   range(431471, 862942)
wowwh      range(862942, 1294413)
    ...
    for i in range(431471,862942):
        ...
        try:
            ...
            if r.status_code == 200:
                open('/nfs/locker/arcts-cavium-hadoop-stage/home/si699w20_cbudak_JI_team/data/dataset/OneMonthData/Image/10033/'+ str(i) + '.jpg', 'wb').write(r.content) 
...
if __name__ == "__main__":
    ...
    df = pd.read_json (r'/nfs/locker/arcts-cavium-hadoop-stage/home/si699w20_cbudak_JI_team/data/dataset/OneMonthData/OneMonth10033.json', lines=True)
